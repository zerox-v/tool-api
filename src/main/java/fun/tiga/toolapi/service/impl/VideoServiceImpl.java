...
import fun.tiga.toolapi.model.dto.VideoInfoDto;
...
public class VideoServiceImpl implements VideoService {
    ...
    public VideoInfoDto phpParsingVideoInfo(String url) {
        String host = "https://tenapi.cn/video/?url="+url;
        String htmlContent = restTemplateUtil.getForObject(host,null, String.class);
        Asserts.urlInfoNotNull(htmlContent, "视频解析异常");
        VideoInfoDto videoInfoDto =JSONObject.parseObject(htmlContent,VideoInfoDto.class);
